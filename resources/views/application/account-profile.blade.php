            ...
            <div class="card-body">
              <div class="d-flex align-items-center">
                <div class="flex-grow-1 me-3">
                  ...
                  <p class="text-white text-opacity-75 text-opa mb-0">Your email is not confirmed. Please check your
                    inbox.
                  ...
                  <div class="card alert alert-warning p-0">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                          <img src="{{ URL::asset('build/images/application/img-accout-password-alert.png') }}" alt="img"
