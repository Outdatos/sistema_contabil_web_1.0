              ...
              <div id="carouselExampleCaptions" class="carousel slide ecomm-prod-slider" data-bs-ride="carousel">
                <div class="carousel-inner bg-light rounded position-relative">
                  ...
                  <div class="carousel-item active">
                    <img src="{{ URL::asset('build/images/application/img-prod-1.jpg') }}" class="d-block w-100" alt="Product images">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ URL::asset('build/images/application/img-prod-2.jpg') }}" class="d-block w-100" alt="Product images">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ URL::asset('build/images/application/img-prod-3.jpg') }}" class="d-block w-100" alt="Product images">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ URL::asset('build/images/application/img-prod-4.jpg') }}" class="d-block w-100" alt="Product images">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ URL::asset('build/images/application/img-prod-5.jpg') }}" class="d-block w-100" alt="Product images">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ URL::asset('build/images/application/img-prod-6.jpg') }}" class="d-block w-100" alt="Product images">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ URL::asset('build/images/application/img-prod-7.jpg') }}" class="d-block w-100" alt="Product images">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ URL::asset('build/images/application/img-prod-8.jpg') }}" class="d-block w-100" alt="Product images">
                  </div>
                </div>
                <ol class="list-inline carousel-indicators position-relative product-carousel-indicators my-sm-3 mx-0">
                  <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" class="list-inline-item w-25 h-auto active">
                    <img src="{{ URL::asset('build/images/application/img-prod-1.jpg') }}" class="d-block wid-50 rounded" alt="Product images">
                  </li>
                  <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="1" class="list-inline-item w-25 h-auto">
                    <img src="{{ URL::asset('build/images/application/img-prod-2.jpg') }}" class="d-block wid-50 rounded" alt="Product images">
                  </li>
                  <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="2" class="list-inline-item w-25 h-auto">
                    <img src="{{ URL::asset('build/images/application/img-prod-3.jpg') }}" class="d-block wid-50 rounded" alt="Product images">
                  </li>
                  <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="3" class="list-inline-item w-25 h-auto">
                    <img src="{{ URL::asset('build/images/application/img-prod-4.jpg') }}" class="d-block wid-50 rounded" alt="Product images">
                  </li>
                  <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="4" class="list-inline-item w-25 h-auto">
                    <img src="{{ URL::asset('build/images/application/img-prod-5.jpg') }}" class="d-block wid-50 rounded" alt="Product images">
                  </li>
                  <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="5" class="list-inline-item w-25 h-auto">
                    <img src="{{ URL::asset('build/images/application/img-prod-6.jpg') }}" class="d-block wid-50 rounded" alt="Product images">
                  </li>
                  <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="6" class="list-inline-item w-25 h-auto">
                    <img src="{{ URL::asset('build/images/application/img-prod-7.jpg') }}" class="d-block wid-50 rounded" alt="Product images">
                  </li>
                  <li data-bs-target="#carouselExampleCaptions" data-bs-slide-to="7" class="list-inline-item w-25 h-auto">
                    <img src="{{ URL::asset('build/images/application/img-prod-8.jpg') }}" class="d-block wid-50 rounded" alt="Product images">
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="card">
      <div class="card-header pb-0">
        <ul class="nav nav-tabs profile-tabs mb-0" id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="ecomtab-tab-1" data-bs-toggle="tab" href="#ecomtab-1" role="tab" aria-controls="ecomtab-1" aria-selected="true">Features
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="ecomtab-tab-2" data-bs-toggle="tab" href="#ecomtab-2" role="tab" aria-controls="ecomtab-2" aria-selected="true">Specifications
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="ecomtab-tab-3" data-bs-toggle="tab" href="#ecomtab-3" role="tab" aria-controls="ecomtab-3" aria-selected="true">Overview
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="ecomtab-tab-4" data-bs-toggle="tab" href="#ecomtab-4" role="tab" aria-controls="ecomtab-4" aria-selected="true">Reviews<span class="badge bg-light-primary rounded-pill px-2 ms-2">275</span>
            </a>
          </li>
        </ul>
      </div>
              ...
              <div class="card-body">
                <div class="d-flex align-items-start">
                  ...
                  <div class="chat-avtar">
                    <img class="img-radius img-fluid wid-40" src="{{ URL::asset('build/images/user/avatar-1.jpg') }}" alt="User image">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-start">
                    <div class="flex-shrink-0">
                  <div class="chat-avtar">
                    <img class="img-radius img-fluid wid-40" src="{{ URL::asset('build/images/user/avatar-2.jpg') }}" alt="User image">
                    <div class="bg-success chat-badge"></div>
                  </div>
                  </div>
                  <div class="flex-grow-1 ms-3">
        ...
        <div class="row gy-3">
            ...
            <div class="card product-card mb-0">
              <div class="card-img-top">
                <a href="{{ url('application/ecom_product-details') }}">
                  <img src="{{ URL::asset('build/images/application/img-prod-2.jpg') }}" alt="image" class="img-prod img-fluid">
                </a>
                <div class="card-body position-absolute end-0 top-0">
                  <div class="form-check prod-likes">
                    <input type="checkbox" class="form-check-input">
          ...
          <div class="col-sm-6 col-xxl-3 col-xl-4">
            <div class="card product-card mb-0">
              <div class="card-img-top">
                <a href="{{ url('application/ecom_product-details') }}">
                  <img src="{{ URL::asset('build/images/application/img-prod-3.jpg') }}" alt="image" class="img-prod img-fluid">
                </a>
                <div class="card-body position-absolute end-0 top-0">
                  <div class="form-check prod-likes">
                    <input type="checkbox" class="form-check-input">
          ...
          <div class="col-sm-6 col-xxl-3 col-xl-4">
            <div class="card product-card mb-0">
              <div class="card-img-top">
                <a href="{{ url('application/ecom_product-details') }}">
                  <img src="{{ URL::asset('build/images/application/img-prod-5.jpg') }}" alt="image" class="img-prod img-fluid">
                </a>
                <div class="card-body position-absolute end-0 top-0">
                  <div class="form-check prod-likes">
                    <input type="checkbox" class="form-check-input">
