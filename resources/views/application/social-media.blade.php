            ...
            <div class="tab-pane show active" id="profile" role="tabpanel">
              <div class="card">
                <div class="card-body user-story-block">
                  ...
                  <div class="horizontal-scroll">
                    <a class="card user-story" data-lightbox="{{ URL::asset('build/images/application/img-story-2.jpg') }}">
                    ...
                    <a class="card user-story" data-lightbox="{{ URL::asset('build/images/application/img-story-3.jpg') }}">
                    ...
                    <a class="card user-story" data-lightbox="{{ URL::asset('build/images/application/img-story-4.jpg') }}">
                    ...
                    <a class="card user-story" data-lightbox="{{ URL::asset('build/images/application/img-story-5.jpg') }}">
                    ...
                    <a class="card user-story" data-lightbox="{{ URL::asset('build/images/application/img-story-6.jpg') }}">
                    ...
                    <a class="card user-story" data-lightbox="{{ URL::asset('build/images/application/img-story-1.jpg') }}">
                      <img src="{{ URL::asset('build/images/application/img-story-1.jpg') }}" class="card-img" alt="img" >
                      <div class="card-img-overlay">
                        <img src="{{ URL::asset('build/images/user/avatar-4.jpg') }}" class="wid-30 rounded-circle img-user" alt="img" >
                      </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row g-2">
                    <div class="col-md-6">
                      <a class="img-post card mb-2" data-lightbox="{{ URL::asset('build/images/application/img-post-1.jpg') }}">
                      ...
                      <div class="row g-2">
                        <div class="col-md-6">
                          <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-post-2.jpg') }}">
                        ...
                        <div class="col-md-6">
                          <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-post-3.jpg') }}">
                    ...
                    <div class="col-md-6">
                      <div class="row g-2 mb-2">
                        <div class="col-md-6">
                          <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-post-4.jpg') }}">
                        ...
                        <div class="col-md-6">
                          <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-post-5.jpg') }}">
                      ...
                      <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-post-6.jpg') }}">
            ...
            <div class="tab-pane" id="gallery" role="tabpanel" aria-labelledby="gallery-tab">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row g-2">
                    <div class="col-md-6">
                      <a class="img-post card social-gallery-card" data-lightbox="{{ URL::asset('build/images/application/img-gallery-1.jpg') }}">
                    ...
                    <div class="col-md-6">
                      <div class="row g-2">
                        <div class="col-md-12">
                          <a class="img-post card social-gallery-card" data-lightbox="{{ URL::asset('build/images/application/img-gallery-2.jpg') }}">
                        ...
                        <div class="col-md-12">
                          <a class="img-post card social-gallery-card" data-lightbox="{{ URL::asset('build/images/application/img-gallery-3.jpg') }}">
                    ...
                    <div class="col-md-4">
                      <a class="img-post card social-gallery-card" data-lightbox="{{ URL::asset('build/images/application/img-gallery-5.jpg') }}">
                    ...
                    <div class="col-md-4">
                      <a class="img-post card social-gallery-card" data-lightbox="{{ URL::asset('build/images/application/img-gallery-6.jpg') }}">
                    ...
                    <div class="col-md-4">
                      <a class="img-post card social-gallery-card" data-lightbox="{{ URL::asset('build/images/application/img-gallery-4.jpg') }}">
                    ...
                    <div class="col-md-6">
                      <a class="img-post card social-gallery-card" data-lightbox="{{ URL::asset('build/images/application/img-gallery-8.jpg') }}">
                    ...
                    <div class="col-md-6">
                      <a class="img-post card social-gallery-card" data-lightbox="{{ URL::asset('build/images/application/img-gallery-7.jpg') }}">
        ...
        <div class="col-lg-4 col-xxl-3">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row g-2">
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-1.jpg') }}">
                ...
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-2.jpg') }}">
                ...
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-3.jpg') }}">
                ...
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-4.jpg') }}">
                ...
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-5.jpg') }}">
                ...
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-6.jpg') }}">
                ...
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-7.jpg') }}">
                ...
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-8.jpg') }}">
                ...
                <div class="col-4">
                  <a class="img-post card" data-lightbox="{{ URL::asset('build/images/application/img-soc-gal-9.jpg') }}">
