                                    ...
                                    <div class="flex-grow-1 mx-2">
                                        ...
                                        <div class="d-flex text-sm text-muted">
                                          <div class="flex-grow-1 position-relative">
                                            <span class="mb-0 text-truncate position-absolute top-0 start-0 w-100"
                                ...
                                <div class="flex-grow-1 mx-3">
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="#"><i class="chat-badge bg-warning"></i> Away</a>
                      ...
                      <ul class="list-inline me-auto mb-0">
                        ...
                        <li class="list-inline-item">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                            <div class="chat-avtar">
                              <img class="rounded-circle img-fluid wid-40" src="{{ URL::asset('build/images/user/avatar-5.jpg') }}" alt="User image" />
                              <i class="chat-badge bg-success"></i>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                          ...
                          <div class="message-in">
                            <div class="d-flex">
                              <div class="flex-shrink-0">
                                <div class="chat-avtar">
                                  <img class="rounded-circle img-fluid wid-40" src="{{ URL::asset('build/images/user/avatar-3.jpg') }}" alt="User image" />
                                  <i class="chat-badge bg-success"></i>
                                </div>
                              </div>
                              <div class="flex-grow-1 mx-3">
                          ...
                          <div class="card bg-transparent shadow-none border-0 mb-0">
                            <div class="text-center card-body position-relative p-3 pb-0 px-0">
                              ...
                              <div class="chat-avtar d-inline-flex mx-auto">
                                <img class="rounded-circle img-fluid wid-100" src="{{ URL::asset('build/images/user/avatar-5.jpg') }}" alt="User image" />
                              </div>
                                  ...
                                  <div class="py-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-start">
                                      ...
                                      <p class="mb-0 text-muted ms-2"
                                        ><span class="badge bg-light-warning text-warning">UI/UX Designer</span></p
                                      >
                                    </div>
                                  </div>
                                </div>
