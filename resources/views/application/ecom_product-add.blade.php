...
<div class="row">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="mb-0">
              <label class="form-label d-flex align-items-center">Cost per items <i class="ph-duotone ph-info ms-1" data-bs-toggle="tooltip" data-bs-title="Cost per items"></i></label>
  ...
  <div class="col-xl-6">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <input class="form-control" id="choices-text-remove-button" type="text" value="Product variants,variants 2" placeholder="Enter something">
      </div>
    </div>
    <div class="card">
      <div class="card-header">
